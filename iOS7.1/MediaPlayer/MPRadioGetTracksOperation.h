...
- (void).cxx_destruct;
- (id)_newGetTracksRequestAllowingHeartbeatDelay:(_Bool)arg1 returningError:(id *)arg2;
...
- (void)main;
- (id)_runFullGetTracksProcessAllowingDialog:(_Bool)arg1 returningError:(id *)arg2;
- (id)_runRequestAllowingHeartbeatDelay:(_Bool)arg1 returningError:(id *)arg2;
- (void)cancel;
- (void)dealloc;
