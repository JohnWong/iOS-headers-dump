...
- (void)_goToMapRegion:(id)arg1 duration:(double)arg2 animationType:(int)arg3 resetHeading:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (id)_commonInitAndEnableLoading:(_Bool)arg1 fromIB:(_Bool)arg2 gestureRecognizerHostView:(id)arg3 showsAttribution:(_Bool)arg4;
