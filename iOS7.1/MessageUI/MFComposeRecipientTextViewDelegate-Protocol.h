...
@class MFComposeRecipient, MFComposeRecipientTextView, MFModernComposeRecipientAtom, MFRecentComposeRecipient, NSArray, NSString;
...
- (void)composeRecipientView:(MFComposeRecipientTextView *)arg1 showPersonCardForRecent:(MFRecentComposeRecipient *)arg2;
