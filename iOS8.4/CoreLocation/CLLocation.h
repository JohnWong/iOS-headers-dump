...
@property(readonly, nonatomic) CDStruct_d81de011 clientLocation;
...
- (id)initWithClientLocation:(CDStruct_d81de011)arg1;
...
- (id)initWithClientLocation:(CDStruct_d81de011)arg1 matchInfo:(id)arg2;
