...
- (void)showMembersOfContactsFilter:(id)arg1 animate:(_Bool)arg2 resetSearch:(_Bool)arg3 loadState:(_Bool)arg4;
...
- (void)showCardForPerson:(void *)arg1 resetFilter:(_Bool)arg2 resetSearch:(_Bool)arg3 fallbackToFirstPerson:(_Bool)arg4;
