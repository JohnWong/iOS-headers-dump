...
@property double navigationBarVerticalOffset; // @synthesize navigationBarVerticalOffset=_navigationBarVerticalOffset;
...
- (id)pdfPreviewData;
- (_Bool)needsContentInsetEvenIfNavigationBarIsHidden;
