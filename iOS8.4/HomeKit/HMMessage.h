...
- (void).cxx_destruct;
- (id)initWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3 transport:(id)arg4 responseHandler:(CDUnknownBlockType)arg5 remoteSource:(_Bool)arg6 internalMessage:(_Bool)arg7;
